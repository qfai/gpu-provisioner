...
func (p *Provider) convertAgentPoolToInstance(ctx context.Context, apObj *armcontainerservice.AgentPool, id string) (*instance.Instance, error) {
...
func (p *Provider) fromRegisteredAgentPoolToInstance(ctx context.Context, apObj *armcontainerservice.AgentPool) (*instance.Instance, error) {
	if apObj == nil {
...
func (p *Provider) fromKaitoAgentPoolToInstance(ctx context.Context, apObj *armcontainerservice.AgentPool) (*instance.Instance, error) {
	if apObj == nil {
		return nil, fmt.Errorf("agent pool is nil")
	}
...
func (p *Provider) fromAPListToInstances(ctx context.Context, apList []*armcontainerservice.AgentPool) ([]*instance.Instance, error) {
